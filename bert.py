...
class bert_ATE(torch.nn.Module):
    ...
    def forward(self, ids_tensors, tags_tensors, masks_tensors, return_dict):
...
class bert_ABSA(torch.nn.Module):
    ...
    def forward(self, ids_tensors, lable_tensors, masks_tensors, segments_tensors , return_dict):
